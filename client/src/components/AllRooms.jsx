...
const AllRooms = () => {
  ...
  const fetchRooms = async () => {
    try {
      setLoading(true);
      const response = await axios.get('https://lushhotels.com.lk/api/rooms');
  ...
  const handleSave = async () => {
    try {
      const response = await axios.put(`https://lushhotels.com.lk/api/rooms/${editMode}`, editedRoom);
      setRooms((prevRooms) =>
  ...
  const handleUpdate = async (roomId) => {
    try {
      const response = await axios.put(`https://lushhotels.com.lk/api/rooms/${roomId}`, editedRoom);
      setRooms((prevRooms) =>
  ...
  const handleDelete = async (roomId) => {
    ...
    try {
      await axios.delete(`https://lushhotels.com.lk/api/rooms/${roomId}`);
